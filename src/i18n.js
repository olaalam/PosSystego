...
const resources = {
  en: {
    translation: {
      ...
      exit: "Exit",
      shift: "Shift",
      WelcomeBackShift: "Welcome Back!",
      ShiftStartedTitle: "The Shift Has Started!",
      WelcomeBackShiftDesc: "Your shift is already active. Resuming your POS session...",
      ShiftStartedDesc: "Your shift is now open. You can start creating orders.",
      PointOfSale: "POS Terminal",
      StartedAt: "Start Time",
      ActiveSince: "Active Since",
      StartSelling: "Start Selling",
      ContinueShift: "Continue Shift",
      ContinueToPos: "Continue to POS",
      AutoRedirectingIn: "Redirecting automatically in",
      //home
      ...
      // Wasted
      AddWasted: "Add Wasted",
      WastedAdded: "Wasted entry created successfully",
      FailedToAddWasted: "Failed to save wasted entry",
      Warehouse: "Warehouse",
      SelectWarehouse: "Select Warehouse",
      Product: "Product",
      SelectProduct: "Select Product",
      Variation: "Variation / Option",
      SelectVariation: "Select Variation / Option",
      ...
      RefundAccounts: "Refund Accounts",
      ...
      ReturnsBreakdown: "Returns Breakdown",
      ReturnsList: "Returns List",
      UnassignedReturns: "Unassigned Returns",
      ClearCustomer: "Clear Customer",
      OnlineOrders: "Online Orders",
      TotalOrders: "Total Orders",
      SearchByOrderNumber: "Search by order ID, city, or address...",
      AllStatuses: "All Statuses",
      ...
      CustomerWillPickupFromWarehouse: "Customer will pick up this order directly from the selected warehouse.",
  ...
  ar: {
    translation: {
      ...
      logout: "تسجيل الخروج",
      exit: "خروج",
      WelcomeBackShift: "مرحباً بعودتك!",
      ShiftStartedTitle: "تم بدء الوردية بنجاح!",
      WelcomeBackShiftDesc: "ورديتك لا تزال جارية، جاري المتابعة مباشرة...",
      ShiftStartedDesc: "تم فتح الوردية بنجاح. يمكنك الآن بدء إنشاء الطلبات.",
      PointOfSale: "نقطة البيع",
      StartedAt: "وقت البدء",
      ActiveSince: "نشط منذ",
      StartSelling: "بدء البيع",
      ContinueShift: "متابعة الوردية",
      ContinueToPos: "المتابعة لنقطة البيع",
      AutoRedirectingIn: "التحويل تلقائياً خلال",
      code: "رمز",
      ...
      // Wasted
      AddWasted: "تسجيل هالك",
      WastedAdded: "تم تسجيل الهالك بنجاح",
      FailedToAddWasted: "فشل في تسجيل الهالك",
      Warehouse: "المستودع",
      SelectWarehouse: "اختر المستودع",
      Product: "المنتج",
      SelectProduct: "اختر المنتج",
      Variation: "التشكيلة / المقاس",
      SelectVariation: "اختر التشكيلة أو المقاس",
      BaseProduct: "المنتج الأساسي",
      Quantity: "الكمية",
      Reason: "السبب",
      SelectReason: "اختر سبب الهالك",
      Note: "ملاحظات",
      Optional: "اختياري",
      ...
      theft: "سرقة",
      lost: "مفقود",
      stocktake_not_found: "عجز جرد (غير موجود)",
      other: "أخرى",
      SearchProduct: "بحث باسم المنتج أو الكود...",
      PleaseSelectWarehouse: "يرجى اختيار المستودع",
      PleaseSelectProduct: "يرجى اختيار المنتج",
      QuantityMustBeGreaterThanZero: "الكمية يجب أن تكون أكبر من 0",
      PleaseSelectReason: "يرجى اختيار سبب الهالك",
      ...
      ReturnedItems: "الأصناف المسترجعة",
      SaledQty: "الكمية المباعة",
      ReturnedQty: "الكمية المسترجعة",
      RefundAccounts: "حسابات رد المبلغ",
      AddAccount: "إضافة حساب",
      ReturnNote: "ملاحظة المرتجع",
      SubmitReturn: "تأكيد المرتجع",
      RefundedTo: "رد المبلغ إلى",
      AvailableToReturn: "المتاح للإرجاع",
      ReturnQty: "الكمية المرتجعة",
      ReturnsBreakdown: "تفاصيل المرتجعات",
      ReturnsList: "قائمة المرتجعات",
      UnassignedReturns: "مرتجعات غير مخصصة",
      ClearCustomer: "مسح اختيار العميل",
      OnlineOrders: "طلبات الأونلاين",
      TotalOrders: "إجمالي الطلبات",
      SearchByOrderNumber: "بحث برقم الطلب، المدينة، أو العنوان...",
      AllStatuses: "جميع الحالات",
      ...
      OrderDetails: "تفاصيل الطلب",
      FulfillmentInformation: "معلومات الاستلام والتوصيل",
      PickupOrder: "طلب استلام من الفرع",
      CustomerWillPickupFromWarehouse: "سيقوم العميل باستلام هذا الطلب مباشرة من المستودع / الفرع المحدد.",
      UpdateOrderStatus: "تحديث حالة الطلب",
      UpdateStatus: "تحديث الحالة",
      StatusUpdatedSuccessfully: "تم تحديث حالة الطلب بنجاح!",
